...
export default function PetaScreen({ onSimpan, onBatal, koordinatAwal }) {
  const [markerPos, setMarkerPos] = useState(
    koordinatAwal || { latitude: 3.6096906, longitude: 125.5056118 }
  );
  const [loadingLokasi, setLoadingLokasi] = useState(false);
  const [region, setRegion] = useState({
    latitude: koordinatAwal?.latitude || 3.6096906,
    longitude: koordinatAwal?.longitude || 125.5056118,
    latitudeDelta: 0.002,
